  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-4 z-50 px-4 sm:px-6">
      <div className="pointer-events-auto mx-auto max-w-4xl rounded-2xl border border-white/10 bg-[#0A1A2F]/95 shadow-[0_12px_36px_rgba(10,26,47,0.22)] backdrop-blur-md">
        <div className="flex flex-col gap-3 px-4 py-3 sm:px-5 sm:py-3 md:flex-row md:items-center md:justify-between md:gap-4">
          ...
          <div className="flex shrink-0 items-center gap-2">
            ...
            <button
              ...
              className="inline-flex h-10 items-center justify-center rounded-full bg-[#D6B24A] px-4 text-sm font-semibold text-[#0A1A2F] transition-colors duration-200 hover:bg-[#E8D9A8] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-300 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A1A2F]"
            >
              Accept
            </button>
          </div>
