        ...
        <div className="grid items-center gap-8 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-12">
          <div className="max-w-2xl">
            <div className="mb-5 flex items-center gap-4">
              <span className="h-px w-14 bg-[linear-gradient(90deg,_rgba(214,178,74,0.84),_rgba(232,217,168,0.18))]" />
              <p className="inline-flex rounded-full border border-[rgba(214,178,74,0.28)] bg-[rgba(247,243,232,0.92)] px-4 py-2 text-xs font-semibold tracking-[0.24em] text-[var(--accent-strong)] uppercase shadow-sm">
            ...
            <h1
              id="hero-title"
              className="max-w-3xl text-4xl font-semibold tracking-[-0.045em] text-slate-950 sm:text-5xl lg:text-[3.6rem] lg:leading-[1.02]"
            >
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <Link
                href="#contact"
                className="inline-flex min-h-13 items-center justify-center rounded-full bg-[#0A1A2F] px-7 text-sm font-semibold text-white shadow-[0_12px_28px_rgba(10,26,47,0.18)] transition-all duration-200 hover:bg-[#132A44] hover:text-white hover:shadow-[0_18px_36px_rgba(10,26,47,0.22)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-300 focus-visible:ring-offset-4 focus-visible:ring-offset-[#fcfcfb] active:translate-y-px"
              >
                <span className="text-white">Get a Quote</span>
              </Link>
              <Link
                href="#products"
                className="inline-flex min-h-13 items-center justify-center rounded-full border border-[rgba(214,178,74,0.28)] bg-white px-7 text-sm font-semibold text-slate-900 shadow-[0_8px_20px_rgba(15,23,42,0.05)] transition-all duration-200 hover:border-[rgba(214,178,74,0.5)] hover:bg-[rgba(247,243,232,0.55)] hover:text-slate-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-300 focus-visible:ring-offset-4 focus-visible:ring-offset-[#fcfcfb] active:translate-y-px"
              >
                Explore Products
              </Link>
            </div>
          ...
          <div className="w-full">
            <div className="group overflow-hidden rounded-xl border border-slate-200/80 bg-white/70 p-2.5 shadow-[0_24px_70px_rgba(15,23,42,0.10)] sm:p-3">
              <div className="relative overflow-hidden rounded-xl bg-slate-100">
                <div className="relative h-[340px] sm:h-[400px] lg:h-[490px]">
